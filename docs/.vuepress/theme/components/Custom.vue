<template>
  <div class="container">
    ...
    <div class="head-social">
      <a href="https://github.com/amatureemoprince" target="_blank" class="head-social-btn">
        <icon name="mdi:github"/>
      </a>
      <router-link to="/blog/" class="head-social-avatar"><img src="/avatar.jpg" alt="avatar"></router-link>
      <a href="https://space.bilibili.com/452646865?spm_id_from=333.788.0.0" target="_blank" class="head-social-btn">
        <icon class="head-social-btn" name="ri:bilibili-line"></icon>
      </a>
    </div>
    <div class="about-me">
        ...
        <AboutMeText>
          <template #motto>
            <slot name="motto">
              ...
              <p class="about-me-card-text-big">想，都是问题；</p>
              <p class="about-me-card-text-big about-me-card-text-color">做，才是答案。</p>
            </slot>
          </template>
        </AboutMeText>
      </div>
